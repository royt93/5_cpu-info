...
>
> **Không lặp lại** nội dung đã có ở `../feature.md` (đã Implemented đợt 1-2) và `../quick_win.md` (feature đã Picked đợt 3) — 2 file đó vẫn là nguồn sự thật cho phần đã quyết định trước đây.
...
| [epic-04-unique-ideas.md](epic-04-unique-ideas.md) | Ý tưởng độc quyền (USP) — U01/U02 được **3 AI review độc lập** cùng tự đề xuất | 12 |

## Đánh giá tổng quan tình trạng repo

- **Đã rất sạch ở phần vừa refactor** (`doc/feature.md` đợt 1-2): TOML, KSP, dead code cũ đã dọn — review lần này không tìm lại bug ở những phần đó.
